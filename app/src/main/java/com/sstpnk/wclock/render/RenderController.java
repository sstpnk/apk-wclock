...
public final class RenderController {
    ...
    private void updateViewState() {
        ...
        view.setDisplaySettings(settings.collageEnabled, settings.photoDisplayMode, settings.photoOrderMode, settings.maxVisiblePhotos, settings.photoChangeSeconds, settings.showSeconds, settings.weatherIconStyle, settings.panelBackgroundAlpha);
